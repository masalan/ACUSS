...
@interface eleveSearch ()<UITableViewDataSource,UITableViewDelegate,
UITextFieldDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (_searchListStudent.student.count > 0)
    {
        if (indexPath.section == 0)
        {
            ...
            SearchElevesCell *cells = [_tableView dequeueReusableCellWithIdentifier:cellIdentity];
            if (cells == nil) {
                cells = [[SearchElevesCell alloc] initWithStyle:UITableViewCellStyleDefault
...
- (void)getData
{
    ...
    [string appendString:@"Search/search_student"];
...
@implementation SearchElevesCell
