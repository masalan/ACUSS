...
@implementation adminProfileCell
...
-(void)drawView {
    ...
    _iconLabel.centerY = self.size.height/2;
    [self addSubview:_iconLabel];
    _titleLabel = [UILabel createLabelWithFrame:CGRectMake(40, 17, SCREEN_WIDTH-(40+80),30)
                                backgroundColor:KCOLOR_Clear
                                      textColor:KCOLOR_GRAY_676767
                                           font:kAutoFont_(13)
                                  textalignment:NSTextAlignmentLeft
    ...
    _rightLabel = [UILabel createLabelWithFrame:CGRectMake(_titleLabel.right, 17,70,30)
                                backgroundColor:KCOLOR_Clear
                                      textColor:KTHEME_COLOR
                                           font:KICON_FONT_(13)
                                  textalignment:NSTextAlignmentRight
