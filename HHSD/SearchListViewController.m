...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (_searchList.school.count > 0)
    {
        if (indexPath.section == 0)
        {
            ...
            SearchCell *cells = [_tableView dequeueReusableCellWithIdentifier:cellIdentity];
            if (cells == nil) {
                cells = [[SearchCell alloc] initWithStyle:UITableViewCellStyleDefault
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    } else
    {
        ...
        SearchDetailsViewController *vc = [[SearchDetailsViewController alloc] init];
