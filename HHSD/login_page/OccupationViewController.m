...
@interface OccupationViewController ()<UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource,MyPickerDelegate>
{
...
- (void)initUI
{
    IMP_BLOCK_SELF(OccupationViewController);
...
- (void)saveSexuser
{
    ...
    kSetDict(_individual_M.profession, @"profession");
    
    
    
    NSMutableString *string = [NSMutableString stringWithString:urlHeader];
    [string appendString:@"User/occupation_signup"];
